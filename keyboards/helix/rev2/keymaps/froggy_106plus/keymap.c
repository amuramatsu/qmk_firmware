...
#define IS_NUMLOCK()	(host_keyboard_leds() & (1<<USB_LED_NUM_LOCK))
#ifndef MAX
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_BASE] = LAYOUT( \
      KC_ESC,        KC_SCLN,       KC_LBRC,       KC_LPRN,   KC_LT,     KC_LCBR,                                _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_BASE_106] = LAYOUT( \
      KC_ESC,        JP_SCLN,       JP_LBRC,       JP_LPRN,   JP_LT,     JP_LCBR,                                _______,  _______,  _______,  _______,  _______,  _______, \
      KANA,          KC_P,          KC_K,          KC_R,      KC_A,      KC_F,                                   _______,  _______,  _______,  _______,  _______,  _______, \
      KC_BSPC,       KC_D,          KC_T,          KC_H,      KC_E,      KC_O,                                   _______,  _______,  _______,  _______,  _______,  _______, \
      OSM(MOD_LSFT), KC_Y,          KC_S,          KC_N,      KC_I,      KC_U,       KC_SPC, _______,  _______,  _______,  _______,  _______,  _______,  _______, \
      OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), L_SYM,     L_NUM,     OPT_TAP_SP, KC_ENT, _______,  _______,  _______,  _______,  _______,  _______,  _______ \
   ...
   */
  [_OPT] = LAYOUT( \
      LCTL(KC_Z),KC_COLN, KC_RBRC, KC_RPRN,KC_GT,     KC_RCBR,                   _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_OPT_106] = LAYOUT( \
      LCTL(KC_Z),JP_COLN, JP_RBRC, JP_RPRN,JP_GT,     JP_RCBR,                   _______,  _______,  _______,  _______,  _______,  _______, \
   ...
   */
  [_SYM] = LAYOUT( \
      KC_INS,  KC_GRV,  KC_DQT,  KC_PGUP, KC_PGDN, KC_CIRC,                   _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_SYM_106] = LAYOUT( \
      KC_INS,  JP_GRV,  JP_DQUO, KC_PGUP, KC_PGDN, JP_CIRC,                   _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_NUM] = LAYOUT( \
      ...
      KC_NLCK,  KC_P0,   KC_1,       KC_2,    KC_3,    LCTL(S(KC_F1)), _______, _______, _______,  _______,  _______,  _______,  _______,  _______, \
      _______,  _______, KC_DOT,     KC_COMM, _______, _______,        _______, _______, _______,  _______,  _______,  _______,  _______,  _______ \
      ),
  [_NUM_106] = LAYOUT( \
      _______,  _______, OSL(_FUNC), KC_HOME, KC_END,  _______,                          _______,  _______,  _______,  _______,  _______,  _______, \
      _______,  JP_ASTR, JP_7,       JP_8,    JP_9,    JP_MINS,                          _______,  _______,  _______,  _______,  _______,  _______, \
      JP_DOT,   JP_SLSH, JP_4,       JP_5,    JP_6,    JP_PLUS,                          _______,  _______,  _______,  _______,  _______,  _______, \
      KC_NLCK,  JP_0,    JP_1,       JP_2,    JP_3,    LCTL(S(KC_F1)), _______, _______, _______,  _______,  _______,  _______,  _______,  _______, \
      _______,  _______, JP_DOT,     JP_COMM, _______, _______,        _______, _______, _______,  _______,  _______,  _______,  _______,  _______ \
      ),
  [_NUM_10KEY] = LAYOUT( \
      _______,  _______, OSL(_FUNC), KC_HOME, KC_END,  _______,                          _______,  _______,  _______,  _______,  _______,  _______, \
      _______,  KC_PAST, KC_P7,      KC_P8,   KC_P9,   KC_PMNS,                          _______,  _______,  _______,  _______,  _______,  _______, \
      KC_PDOT,  KC_PSLS, KC_P4,      KC_P5,   KC_P6,   KC_PPLS,                          _______,  _______,  _______,  _______,  _______,  _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case L_NUM:
      if (record->event.pressed) {
        if (IS_NUMLOCK()) {
          register_delay_code(_NUM_10KEY);
          layer_on(_NUM_10KEY);
        }else if (IS_MODE_106()){
        ...
        layer_off(_NUM);
        layer_off(_NUM_106);
        layer_off(_NUM_10KEY);
        if(delay_registered_layer == _NUM || delay_registered_layer == _NUM_106 || delay_registered_layer == _NUM_10KEY) {
          unregister_delay_code();
        }
      }
      return false;
      break;
    case KC_NLCK:
      if(IS_LAYER_ON(_NUM)||IS_LAYER_ON(_NUM_106)||IS_LAYER_ON(_NUM_10KEY)){
        if(!record->event.pressed) {
          layer_off(_NUM);
          layer_off(_NUM_106);
          layer_off(_NUM_10KEY);
  ...
  if(layer_state_old != layer_state){
    ...
    if(!RGBAnimation){
      if(IS_LAYER_ON(_FUNC)){
        ...
        #endif
      }else if(IS_LAYER_ON(_NUM)||IS_LAYER_ON(_NUM_106)||IS_LAYER_ON(_NUM_10KEY)){
        #ifdef RGBLED_BACK
